...
OBJ_DATA *create_object( OBJ_INDEX_DATA *pObjIndex )
{
    ...
    *obj		= obj_zero;
    ...
    obj->type		= pObjIndex->type;
    obj->extra_flags	= pObjIndex->extra_flags;
    obj->wear_flags	= pObjIndex->wear_flags;
    obj->weight		= pObjIndex->weight;
    obj->cost		= pObjIndex->cost;
    obj->weapon		= pObjIndex->weapon;
    obj->armor		= pObjIndex->armor;
    obj->cont		= pObjIndex->cont;
    obj->food		= pObjIndex->food;
    obj->spells		= pObjIndex->spells;
    obj->use		= pObjIndex->use;
    obj->light		= pObjIndex->light;
...
/*    EXTRA_DESCR_DATA *ed,*ed_new; */
    ...
    /* values */
    clone->weapon	= copy_weapon(parent,TRUE);
    clone->armor	= copy_armor(parent,TRUE);
    clone->cont		= copy_cont(parent,TRUE);
    clone->food		= copy_food(parent,TRUE);
    clone->spells	= copy_spells(parent,TRUE);
    clone->use		= copy_use(parent,TRUE);
    clone->light	= copy_light(parent,TRUE);
...
/* RT comment in when not debugging
    if ( fBootDb )
    {
